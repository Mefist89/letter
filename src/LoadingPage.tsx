...
const REQUIRED_FILES = [
 { id: 'sakura-audio', name: 'sakura.mp3', type: 'audio', path: '/sakura.mp3' },
 { id: 'background-img', name: 'background.jpg', type: 'image', path: '/background.jpg' },
 { id: 'letter-content', name: 'letter.json', type: 'data', path: '/letter.json' },
];
          ...
          {loading ? (
            <div className="mt-6">
              <div className="w-full bg-blue-800/30 rounded-full h-2.5">
                <div className="bg-blue-400 h-2.5 rounded-full animate-pulse" 
                     style={{ width: '60%' }}></div>
              </div>
            ...
            <div className="mt-6 text-center">
              ...
              <p className="text-red-400 font-medium mb-2">
                {errorFiles.length} file{errorFiles.length !== 1 ? 's' : ''} missing or incomplete
              </p>
