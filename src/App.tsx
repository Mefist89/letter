...
const NightLetterApp = () => {
  ...
  const questionText = "С днём рождения! В этот день желаю тебе береги ту искру, которая в тебе есть. Пусть она горит ярче и сильнее всех вокруг. Желаю огромной любви, счастья и чтобы твои глаза всегда горели от радости и вдохновения. Ты этого достойна!!!";
  ...
  useEffect(() => {
    ...
    } else if (letterOpen && displayedText.length === questionText.length && !letterClosing) {
   ...
   useEffect(() => {
     const playAudio = async () => {
       try {
         ...
         console.log('Audio play failed (this is expected on first load due to user interaction policy):', error);
       }
     };
  ...
  return (
    <div id="app-page" className="relative w-full h-screen overflow-hidden">
      <link href="https://fonts.googleapis.com/css2?family=Parisienne&family=Dancing+Script:wght@400;700&display=swap" rel="stylesheet" />
      ...
      <div className="absolute inset-0">
        ...
        {fireflies.map(firefly => (
          <div
            ...
            style={{
              ...
              background: 'radial-gradient(circle, rgba(255, 255, 150, 0.9) 0%, rgba(255, 255, 100, 0.3) 50%, transparent 70%)',
        ...
        <div className="absolute bottom-0 left-0 right-0">
          ...
          <svg className="absolute bottom-0 w-full" viewBox="0 0 1200 500" preserveAspectRatio="none" style={{ height: '65vh' }}>
            <path d="M0,250 L150,150 L300,190 L450,130 L600,170 L750,120 L900,160 L1050,140 L1200,180 L1200,500 L0,500 Z" 
                  fill="rgba(30, 58, 138, 0.8)" />
            <path d="M0,300 L100,220 L250,260 L400,210 L550,250 L700,200 L850,240 L1000,220 L1200,260 L1200,500 L0,500 Z" 
                  fill="rgba(30, 58, 138, 0.6)" />
            <path d="M0,340 L150,280 L300,320 L450,270 L600,310 L750,260 L900,300 L1050,280 L1200,320 L1200,500 L0,500 Z" 
                  fill="rgba(30, 58, 138, 0.4)" />
          </svg>

          {/* Холм на переднем плане - высокий */}
          <svg className="absolute bottom-0 w-full" viewBox="0 0 1200 350" preserveAspectRatio="none" style={{ height: '40vh' }}>
            <path d="M0,150 Q300,100 600,150 T1200,150 L1200,350 L0,350 Z" 
                  fill="rgba(15, 23, 42, 0.95)" />
            <path d="M0,200 Q300,160 600,200 T1200,200 L1200,350 L0,350 Z" 
          ...
          <svg className="absolute right-8 sm:right-16 bottom-0" width="200" height="400" viewBox="0 0 300 550" preserveAspectRatio="xMidYMax meet" style={{ height: '50vh', width: 'auto' }}>
            {/* Ствол */}
            <rect x="135" y="320" width="30" height="230" fill="rgba(15, 23, 42, 1)" rx="5" />
            ...
            {/* Основные ветки */}
            <ellipse cx="90" cy="340" rx="25" ry="15" fill="rgba(15, 23, 42, 1)" transform="rotate(-30 90 340)" />
            <ellipse cx="210" cy="340" rx="25" ry="15" fill="rgba(15, 23, 42, 1)" transform="rotate(30 210 340)" />
            <ellipse cx="75" cy="380" rx="20" ry="12" fill="rgba(15, 23, 42, 1)" transform="rotate(-40 75 380)" />
            <ellipse cx="225" cy="380" rx="20" ry="12" fill="rgba(15, 23, 42, 1)" transform="rotate(40 225 380)" />
          </svg>
        </div>
        ...
        <div 
          ...
          style={{
            ...
            boxShadow: '0 0 60px 20px rgba(147, 197, 253, 0.4), inset -8px -8px 20px rgba(191, 219, 254, 0.3)'
          }}
        >
        ...
        <div className="absolute top-10 left-10 w-24 h-24 opacity-20">
          <svg viewBox="0 0 100">
            <circle cx="30" cy="30" r="25" fill="white" opacity="0.3" className="blur-xl" />
            <circle cx="70" cy="50" r="20" fill="white" opacity="0.2" className="blur-xl" />
          </svg>
        </div>

        <div className="absolute top-32 left-1/3 w-32 h-32 opacity-15">
          <svg viewBox="0 0 100 100">
            <circle cx="50" cy="50" r="40" fill="white" opacity="0.25" className="blur-2xl" />
          </svg>
        </div>
        ...
        <div className="absolute bottom-1/3 right-1/4 w-28 h-28 opacity-15">
          <svg viewBox="0 0 100 100">
            <circle cx="50" cy="50" r="35" fill="white" opacity="0.2" className="blur-2xl" />
          </svg>
        </div>

        <div className="absolute bottom-1/4 left-1/4 w-20 h-20 opacity-20">
          <svg viewBox="0 0 100 100">
            <circle cx="40" cy="40" r="30" fill="white" opacity="0.25" className="blur-xl" />
          </svg>
        </div>

        {/* Письмо */}
        {showLetter && !letterClosing && (
          <div className="absolute inset-0 flex items-center justify-center" style={{ animation: 'letter-fade-in 2s ease-out' }}>
              ...
              {!letterOpen ? (
                ...
                >
                  <div className="w-64 h-44 sm:w-80 sm:h-56 bg-gradient-to-br from-sky-300 to-sky-400 rounded-lg shadow-2xl shadow-blue-400/50 relative">
                    <div className="absolute top-0 left-0 w-full h-20 sm:h-28 bg-gradient-to-br from-sky-400 to-sky-500 rounded-t-lg"
                      style={{
                    ...
                    {/* Сердечко слева */}
                    <div className="absolute bottom-3 left-3 sm:bottom-4 sm:left-4 w-10 h-10 sm:w-12 sm:h-12 rounded-full border-3 sm:border-4 border-blue-700 flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="w-5 h-5 sm:w-6 sm:h-6">
                        <path d="M12 21C12 21 3 15 3 9C3 6 5 4 7.5 4C9.5 4 11 5 12 7C13 5 14.5 4 16.5 4C19 4 21 6 21 9C21 15 12 21 12 21Z" 
                              fill="#2563eb" 
                              stroke="#1e40af" 
                              strokeWidth="1"/>
                      </svg>
                    ...
                    <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 sm:bottom-4 w-15 h-15 sm:w-18 sm:h-18 rounded-full border-3 sm:border-4 border-blue-700 flex items-center justify-center">
                      <svg width="36" height="36" viewBox="0 0 24 24" fill="none" className="w-7 h-7 sm:w-9 sm:h-9">
                        {/* Нижний ярус */}
                        <rect x="4" y="14" width="16" height="6" rx="1" fill="#2563eb" stroke="#1e40af" strokeWidth="0.5"/>
                        
                        {/* Средний ярус */}
                        <rect x="6" y="10" width="12" height="4" rx="1" fill="#3b82f6" stroke="#1e40af" strokeWidth="0.5"/>
                        
                        {/* Верхний ярус */}
                        <rect x="8" y="7" width="8" height="3" rx="0.5" fill="#60a5fa" stroke="#1e40af" strokeWidth="0.5"/>
                        
                        {/* Свеча */}
                        <rect x="11" y="4" width="2" height="3" fill="#1e40af"/>
                        
                        {/* Огонь свечи */}
                        <ellipse cx="12" cy="3.5" rx="1.5" ry="2" fill="#fbbf24"/>
                        <ellipse cx="12" cy="3.5" rx="0.8" ry="1.2" fill="#fef3c7"/>
                        
                        {/* Декор на тортах */}
                        <circle cx="8" cy="12" r="0.5" fill="#1e40af"/>
                        <circle cx="12" cy="12" r="0.5" fill="#1e40af"/>
                        <circle cx="16" cy="12" r="0.5" fill="#1e40af"/>
                        
                        <circle cx="10" cy="17" r="0.5" fill="#1d4ed8"/>
                        <circle cx="14" cy="17" r="0.5" fill="#1d4ed8"/>
                      </svg>
                    </div>
                    
                    {/* Роза справа */}
                    <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 w-10 h-10 sm:w-12 sm:h-12 rounded-full border-3 sm:border-4 border-blue-700 flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="w-5 h-5 sm:w-6 sm:h-6">
                        {/* Лепестки розы */}
                        <path d="M12 6C10 6 9 7 9 8.5C9 10 10 11 12 11C14 11 15 10 15 8.5C15 7 14 6 12 6Z" 
                              fill="#3b82f6" />
                        <path d="M8 9C7 9 6 10 6 11.5C6 13 7 14 9 14C10 14 11 13 11 11.5C11 10 10 9 8 9Z"
                              fill="#2563eb" />
                        <path d="M16 9C17 9 18 10 18 11.5C18 13 17 14 15 14C14 14 13 13 13 11.5C13 10 14 9 16 9Z" 
                              fill="#2563eb" />
                        <path d="M12 11C10 11 9 12 9 13.5C9 15 10 16 12 16C14 16 15 15 15 13.5C15 12 14 11 12 11Z" 
                              fill="#1e40af" />
                        <path d="M10 13C9 13 8 14 8 15C8 16 9 17 10 17C11 17 12 16 12 15C12 14 11 13 10 13Z" 
                              fill="#1d4ed8" />
                        <path d="M14 13C15 13 16 14 16 15C16 16 15 17 14 17C13 17 12 16 12 15C12 14 13 13 14 13Z" 
                              fill="#1d4ed8" />
                        ...
                        {/* Стебель */}
                        <path d="M12 16 L12 20" stroke="#1e40af" strokeWidth="1.5" strokeLinecap="round"/>
                        
                        {/* Листья */}
                        <path d="M12 18 Q10 17 9 18" stroke="#1e40af" strokeWidth="1" fill="none"/>
                        <path d="M12 17 Q14 16 15 17" stroke="#1e40af" strokeWidth="1" fill="none"/>
                      </svg>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-[24rem] sm:w-[28.8rem] mx-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-2xl shadow-blue-500/50 p-6 sm:p-8 transform animate-unfold max-h-[80vh] overflow-y-auto">
                  <div className="flex flex-col items-center justify-center">
                    <p className="text-xl sm:text-2xl text-blue-900 text-center pb-3 sm:pb-4 border-b-2 border-blue-300 mb-6" style={{ fontFamily: "'Parisienne', 'Dancing Script', cursive", lineHeight: '1.8' }}>
                      {displayedText}
                    ...
                    {displayedText.length === questionText.length && (
                      <div className="flex gap-6 sm:gap-8 mt-4 animate-fade-in">
                        ...
                        <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full border-3 sm:border-4 border-blue-700 flex items-center justify-center bg-blue-50">
                          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="w-6 h-6 sm:w-8 sm:h-8">
                            <path d="M12 21C12 21 3 15 3 9C3 6 5 4 7.5 4C9.5 4 11 5 12 7C13 5 14.5 4 16.5 4C19 4 21 6 21 9C21 15 12 21 12 21Z" 
                                  fill="#2563eb" 
                                  stroke="#1e40af" 
                                  strokeWidth="1"/>
                        ...
                        <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-full border-3 sm:border-4 border-blue-700 flex items-center justify-center bg-blue-50">
                          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" className="w-9 h-9 sm:w-12 sm:h-12">
                            <rect x="4" y="14" width="16" height="6" rx="1" fill="#2563eb" stroke="#1e40af" strokeWidth="0.5"/>
                            <rect x="6" y="10" width="12" height="4" rx="1" fill="#3b82f6" stroke="#1e40af" strokeWidth="0.5"/>
                            <rect x="8" y="7" width="8" height="3" rx="0.5" fill="#60a5fa" stroke="#1e40af" strokeWidth="0.5"/>
                            <rect x="11" y="4" width="2" height="3" fill="#1e40af"/>
                        ...
                        {/* Роза */}
                        <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full border-3 sm:border-4 border-blue-700 flex items-center justify-center bg-blue-50">
                          <svg width="32" height="32" viewBox="0 0 24" fill="none" className="w-6 h-6 sm:w-8 sm:h-8">
                            <path d="M12 6C10 6 9 7 9 8.5C9 10 10 11 12 11C14 11 15 10 15 8.5C15 7 14 6 12 6Z"
                                  fill="#3b82f6" />
                            <path d="M8 9C7 9 6 10 6 11.5C6 13 7 14 9 14C10 14 11 13 11 11.5C11 10 10 9 8 9Z"
                                  fill="#2563eb" />
        ...
        {letterClosing && showLetter && (
          <div className="absolute inset-0 flex items-center justify-center" style={{ pointerEvents: 'none' }}>
            <div className="animate-letter-exit" onAnimationEnd={() => setShowLetter(false)}>
              <div className="w-64 h-44 sm:w-80 sm:h-56 bg-gradient-to-br from-sky-300 to-sky-400 rounded-lg shadow-2xl shadow-blue-400/50 relative">
                <div className="absolute top-0 left-0 w-full h-20 sm:h-28 bg-gradient-to-br from-sky-400 to-sky-500 rounded-t-lg"
                  style={{
                    clipPath: 'polygon(0 0, 50% 60%, 100% 0)'
                ...
                <div className="absolute inset-0 flex items-center justify-center mt-8 sm:mt-12">
                  ...
                  {/* Губы */}
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" className="w-10 h-10 sm:w-12 sm:h-12 mt-2">
                    {/* Верхняя губа */}
                    <path d="M7 12C7 12 9 10 12 10C15 10 17 12 17 12C17 12 15 13 12 13C9 13 7 12 7 12Z" 
                          fill="#dc2626" 
                          stroke="#b91c1c" 
                          strokeWidth="0.5"/>
                    {/* Нижняя губа */}
                    <path d="M7 12C7 12 8 15 12 15C16 15 17 12 17 12C17 12 16 14 12 14C8 14 7 12 7 12Z" 
                          fill="#ef4444" 
                          stroke="#b91c1c" 
                          strokeWidth="0.5"/>
                    {/* Блик на губах */}
                    <ellipse cx="10" cy="13" rx="1.5" ry="0.8" fill="#fca5a5" opacity="0.6"/>
                  </svg>
                </div>
              </div>
            </div>
      ...
      <style jsx>{`
        ...
        .aurora-1 {
          top: 0;
          background: linear-gradient(90deg, transparent, rgba(34, 211, 238, 0.4), rgba(59, 130, 246, 0.4), transparent);
        ...
        .animate-letter-exit {
          animation: letter-exit 10s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards;
